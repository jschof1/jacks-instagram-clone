...
function App() {
  ...
  // This is to toggle from DE to EN
          ...
          <form className="app__signup">
            <center>
              <img 
                ...
                height="40px;"
                src = "https://i.ibb.co/M58qcg8/Screenshot-2020-12-16-at-19-39-52.png"
                alt=""
              />
            </center>
            ...
            <Input 
              type="text"
              placeholder={lang ? "Nutzernamer":"username"}
              value={username}
            ...
            <Input 
              placeholder={lang ? "passwort":"password"}
              type="password"
              value={password}
              onChange={(e) => setPassword(e.target.value)}
            />
            <Button type="submit" onClick={signUp}>{lang ? "Anmelden":"Sign Up"}</Button>
        ...
        <div style={modalStyle} className={classes.paper}>
          <form className="app__signup">
            ...
            <Input 
              ...
              onChange={(e) => setPassword(e.target.value)}
            />
            <Button type="submit" onClick={signIn}>{lang ? "Anmelden":"Sign In"}</Button>
      ...
      <header className="app__header">
        ...
        <div className="app__loginContainer">
              ...
              <div className="loginLeft">
                { user ? (
                  <Button onClick={() => auth.signOut()}>{lang ? "Ausloggen":"Logout"}</Button>
                ) : (
                  <Button onClick={() => toggleLang()}>{lang ? "EN":"DE"}</Button>
                )
                }
            ...
            <div className="loginRight">
              <Button  aria-controls="fade-menu" aria-haspopup="true" > 
                <MenuPopupState 
                  ...
                  labeltopass={lang ? "English Version" : "Deutsche Version"}
                  signout={() => auth.signOut()}
                  signoutlabel={lang ? "Ausloggen":"Logout"}
                  signin={() => setOpenSignIn(true)}
                  signinlabel={lang ? "Einloggen" : "Sign In"}
                  signup={() => setOpen(true)}
                  signuplabel={lang ? "Anmelden" : "Sign Up"}
                />
              </Button>
          ...
          <div>
            ...
            <div className="footer__icons">
              <div className="footer__left">
                <img onClick={home} className="app__home" src="https://img.icons8.com/material-rounded/24/000000/home.png" alt='home icon to go back up'/>         
              </div>

              <div className="footer__middle">
                <img onClick={() => setOpenImageUpload(true)} className="app__add-postImg" src="https://img.icons8.com/pastel-glyph/64/000000/plus--v1.png" alt='plus icon to add posts'/>
              </div>
          ...
          <div className="footer__icons">
              ...
              <div className="footer__middle">
                  <Button onClick={() => setOpenSignIn(true)}>
                    {lang ? "EINLOGGEN":"SIGN IN"} &nbsp;&nbsp;
                  </Button> 
                  <Button onClick={() => setOpen(true)}>
                    {lang ? "ANMELDEN":"SIGN UP"}
                  </Button>
